        ...
        <div className="w-full bg-white">
            ...
            <section id="tours" className="w-full bg-[#f9fafb] py-12 md:py-24 px-4 md:px-12 relative overflow-hidden">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-7xl mx-auto">
                    {[
                        { title: t("tourism.north"), img: "https://res.cloudinary.com/dtdvglgx4/image/upload/v1770804888/north-india_18_11zon_yd25mv.jpg", href: `${locale}/optional-tour/north` },
                        { title: t("tourism.south"), img: "https://res.cloudinary.com/dtdvglgx4/image/upload/v1770804890/south-india_23_11zon_sqg9c3.jpg", href: `${locale}/optional-tour/south` },
                        { title: t("tourism.east"), img: "https://res.cloudinary.com/dtdvglgx4/image/upload/v1770792790/east-india_rlbnqo.jpg", href: `${locale}/optional-tour/east` },
                        { title: t("tourism.west"), img: "https://res.cloudinary.com/dtdvglgx4/image/upload/v1770804895/west-india_25_11zon_f7jk4g.jpg", href: `${locale}/optional-tour/west` },
                    ].map((region, idx) => (
