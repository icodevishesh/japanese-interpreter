            ...
            <div className="relative w-full bg-[#12aa91] text-white py-2 px-4 md:px-12 flex justify-between items-center text-xs md:text-sm overflow-hidden">
                ...
                <div className="relative z-10 flex items-center gap-4 md:gap-6">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <a href="mailto:bk.indotours@gmail.com" className="hidden sm:inline cursor-pointer hover:underline">bk.indotours@gmail.com</a>
                        <a href="mailto:bk.indotours@gmail.com" className="sm:hidden text-[10px] cursor-pointer hover:underline">bk.indotours@gmail.com</a>
                    </div>
                </div>
                <div className="relative z-10 flex items-center gap-4 md:gap-6">
